...
def runUpdate():    
    ...
    for line in lines:
        try:
            ...
            if(verify.tableExists(name)== False):# if the table doesnt already exist then make it and load all the history
            ...
            website="https://finance.yahoo.com/quote/"+line+"?p="+line+"&.tsrc=fin-srch"# website is easy to get with the stock name
